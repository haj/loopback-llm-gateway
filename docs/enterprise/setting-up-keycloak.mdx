...
{/* TODO screenshot: <Frame> <img src="/media/user-provisioning/keycloak-create-client.png" alt="Creating a client in Keycloak" /> </Frame> */}
...
{/* TODO screenshot: <Frame> <img src="/media/user-provisioning/keycloak-capability-config.png" alt="Keycloak client capability configuration" /> </Frame> */}
...
{/* TODO screenshot: <Frame> <img src="/media/user-provisioning/keycloak-client-credentials.png" alt="Keycloak client credentials tab" /> </Frame> */}
...
{/* TODO screenshot: <Frame> <img src="/media/user-provisioning/keycloak-group-mapper.png" alt="Group Membership mapper configuration" /> </Frame> */}
...
{/* TODO screenshot: <Frame> <img src="/media/user-provisioning/keycloak-service-account-roles.png" alt="Keycloak service account roles" /> </Frame> */}
...
2. Select **Keycloak** as the OIDC Provider.
...
{/* TODO screenshot: <Frame> <img src="/media/user-provisioning/keycloak-bifrost-config.png" alt="Bifrost Keycloak configuration form" /> </Frame> */}
...
Bifrost does not currently support Keycloak SCIM management APIs or inbound Keycloak SCIM provisioning. Do not configure a Keycloak SCIM connector, plugin, or automation layer to call Bifrost `/scim/v2` yet.

For Keycloak, Bifrost uses the Admin REST API setup above to sync users in the background every **24 hours**. During that sync, Bifrost reconciles imported users, role mappings, team mappings, and business-unit mappings from Keycloak.

Every **15 minutes**, Bifrost also refreshes active OIDC sessions. If a session cannot be refreshed, Bifrost checks with Keycloak whether the user is still active; if Keycloak reports the user is inactive, Bifrost decommissions that user locally.

Support for Keycloak SCIM management APIs is coming soon.
