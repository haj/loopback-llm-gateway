...
<Info>
  ...
  Reference](https://github.com/haj/loopback-llm-gateway/blob/main/docs/openapi/openapi.json). All role and permission endpoints are tagged **RBAC**.
</Info>
...
For programmatic configuration (create role, update scope, assign role to user, manage permissions), see the **RBAC** endpoints in the [API Reference](https://github.com/haj/loopback-llm-gateway/blob/main/docs/openapi/openapi.json).
