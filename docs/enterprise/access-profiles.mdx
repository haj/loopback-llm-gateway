...
<Info>
  ...
  **Access Profiles** section of the [API Reference](https://github.com/haj/loopback-llm-gateway/blob/main/docs/openapi/openapi.json).
</Info>
...
For programmatic configuration (every endpoint, body shape, and error code), see the **Access Profiles** section of the [API Reference](https://github.com/haj/loopback-llm-gateway/blob/main/docs/openapi/openapi.json).

---

## What you can configure

A profile carries the following pieces of policy. Use the UI walkthrough above for guidance and see the [API Reference](https://github.com/haj/loopback-llm-gateway/blob/main/docs/openapi/openapi.json) for exact field shapes.
