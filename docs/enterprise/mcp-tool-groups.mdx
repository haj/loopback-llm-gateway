...
<Info>
  ...
  Tool Groups** section of the [API Reference](https://github.com/haj/loopback-llm-gateway/blob/main/docs/openapi/openapi.json).
</Info>
...
For programmatic configuration (every endpoint, body shape, and error code), see the **MCP Tool Groups** section of the [API Reference](https://github.com/haj/loopback-llm-gateway/blob/main/docs/openapi/openapi.json).
