...
const (
	...
	// ConfigRBACEnforcementKey persists the operator's one-click RBAC
	// enforcement decision ("true"/"false"). The effective runtime state is
	// env (LOOPBACK_RBAC_ENABLED) OR this flag; a missing key means disabled
	// (fail-open).
	ConfigRBACEnforcementKey = "rbac_enforcement_enabled"
)
