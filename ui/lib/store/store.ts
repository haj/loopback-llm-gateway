...
import { appReducer, kafkaConnectorReducer, pluginReducer, providerReducer } from "./slices";
...
export const store = configureStore({
	reducer: {
		...
		// Kafka data connector form state slice
		kafkaConnector: kafkaConnectorReducer,
