...
// PromptDeploymentVersionRef is a weighted pointer from a deployment to a
// concrete prompt version. The resolver splits live traffic across refs in
// proportion to their weight, and falls back to the latest version when a
// referenced version has been deleted.
export interface PromptDeploymentVersionRef {
	version_number: number;
	weight: number;
}

// PromptDeployment is a named, weighted traffic-routing strategy for a prompt.
...
export interface ListPromptDeploymentsResponse {
	deployments: PromptDeployment[];
	count: number;
}

export interface GetPromptDeploymentResponse {
	deployment: PromptDeployment;
}

export interface CreatePromptDeploymentRequest {
	promptId: string;
	name: string;
	enabled?: boolean;
	versions: PromptDeploymentVersionRef[];
...
export interface UpdatePromptDeploymentRequest {
	id: string;
	promptId: string;
	name?: string;
	enabled?: boolean;
...
export interface PromptDeploymentMutationResponse {
	message: string;
	deployment: PromptDeployment;
}

export interface DeletePromptDeploymentResponse {
	message: string;
}