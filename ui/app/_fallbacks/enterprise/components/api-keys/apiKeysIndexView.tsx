			...
			<Alert variant="default">
				...
				<AlertDescription>
					<p className="text-md text-muted-foreground">
						...
						.<br />
						<br />
						Once generated you will need to use this API key for all API calls to the Loopback Gateway admin APIs and UI.
					</p>
				</AlertDescription>
			</Alert>
		);
	...
	return (
		<div className="mx-auto w-full max-w-4xl space-y-4">
				...
				<AlertDescription>
					<p className="text-md text-muted-foreground">
						{isInferenceAuthDisabled ? (
							...
							<>
								Use Basic auth with your admin credentials when making API calls to Loopback Gateway. Encode your credentials in the
								standard <code className="bg-muted rounded px-1 py-0.5 text-sm">username:password</code> format with base64 encoding.
							</>
						)}
					</p>
					{!isInferenceAuthDisabled && (
			...
			<ContactUsView
				...
				readmeLink="https://docs.loopback.gateway/enterprise/api-keys"
			/>
		</div>
	);
}