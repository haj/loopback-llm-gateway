							...
							<div className="flex items-center justify-between">
								<div className="space-y-0.5">
									...
									<p className="text-muted-foreground text-sm">
										Set up authentication credentials to protect your Loopback Gateway dashboard. Once configured, use the generated token
				...
				<div className="flex items-center justify-between space-x-2 rounded-sm border p-4">
					<div className="space-y-0.5">
						...
						<p className="text-muted-foreground text-sm">
							...
							See{" "}
							<a
								href="https://docs.loopback.gateway/features/governance/virtual-keys"
								target="_blank"
				...
				<div className="flex items-center justify-between space-x-2 rounded-sm border p-4">
					<div className="space-y-0.5">
						...
						<p className="text-muted-foreground text-sm">
							...
							<b>x-goog-api-key</b> header alongside <b>x-bf-direct-key: true</b>. Loopback Gateway will use that key directly, bypassing
							the registered key pool.
						</p>
					</div>
					<Switch
...
const RestartWarning = () => {
	return (
		<Alert variant="destructive" className="mt-2">
			<AlertTriangle className="h-4 w-4" />
			<AlertDescription>Need to restart Loopback Gateway to apply changes.</AlertDescription>
		</Alert>
	);
};