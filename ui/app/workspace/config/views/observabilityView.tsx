	...
	return (
		<div className="mx-auto w-full max-w-4xl space-y-4">
			...
			<Alert variant="destructive">
				...
				<AlertDescription>
					These settings require a Loopback Gateway service restart to take effect. Current connections will continue with existing settings
					until restart.
				</AlertDescription>
			</Alert>
...
const RestartWarning = () => {
	return <div className="text-muted-foreground mt-2 pl-4 text-xs font-semibold">Need to restart Loopback Gateway to apply changes.</div>;
};