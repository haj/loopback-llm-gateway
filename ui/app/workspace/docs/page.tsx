...
const docSections = [
	{
		title: "Quick Start",
		description: "Get Loopback Gateway running in under 30 seconds",
		icon: Play,
	...
	{
		title: "Architecture",
		description: "Deep dive into Loopback Gateway's design and performance",
		icon: GitBranch,
	...
	{
		title: "Contributing",
		description: "Help improve Loopback Gateway for everyone",
		icon: Users,
			...
			<div className="mx-auto max-w-7xl">
				<div className="space-y-8">
					...
					<div className="space-y-4 text-center">
						...
						<GradientHeader title="Power Up Your Loopback Gateway Stack" />
						<p className="text-muted-foreground mx-auto max-w-2xl text-lg">
							Everything you need to know about building production AI applications with Loopback Gateway
						</p>
