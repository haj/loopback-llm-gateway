		...
		<CenteredCard>
			...
			<p className="text-muted-foreground mt-2 text-sm">
				{isReauth ? (
					...
					<>
						You'll be redirected to the provider to sign in and grant access. Loopback Gateway stores the resulting credential against the
	...
	if (submitted === "true") {
		return (
			<CenteredCard>
				...
				<p className="text-muted-foreground mt-2 text-sm">
					Loopback Gateway verified the connection and stored your credentials. You can close this tab and retry the original action.
				</p>
				<div className="mt-6 flex gap-3">
					<SessionsTabLink />
				</div>
