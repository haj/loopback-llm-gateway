...
const SKILLS_REPOSITORY_DOCS_URL = "https://docs.loopback.gateway/features/skills-repository";
		...
		return (
			<div className="flex h-full w-full flex-col items-center justify-center gap-4 text-center" data-testid="skills-repo-empty-state">
				...
				<div className="flex flex-col gap-1">
					<h1 className="text-muted-foreground text-xl font-medium">Create, version, and share Agent Skills from Loopback Gateway</h1>
						...
						<Tooltip>
							...
							<TooltipContent side="bottom">
								<p className="max-w-xs text-xs">
									Git is not available on the server. Install git and restart Loopback Gateway to enable marketplace registration for Claude
									Code and Codex.
								</p>
							</TooltipContent>
						</Tooltip>
