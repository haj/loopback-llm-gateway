...
const ClientForm: React.FC<ClientFormProps> = ({ open, onClose, onSaved }) => {
	...
	// stdio process reads it from Loopback Gateway's host environment.
			...
			stdio_config:
				connectionType === "stdio"
					? {
							...
							// (read from Loopback Gateway's host environment). Rows without a name are skipped.
											...
											<TooltipProvider>
												<Tooltip>
													<TooltipTrigger asChild>
														<a
															href="https://docs.loopback.gateway/mcp/code-mode"
															target="_blank"
																...
																<div className="flex items-center gap-2">
																	...
																	<TooltipProvider>
																		<Tooltip>
																			...
																			<TooltipContent className="max-w-xs">
																				<p>
																					Leave empty to use Dynamic Client Registration (RFC 7591). Loopback Gateway will automatically
																					register with the OAuth provider if supported.
																				</p>
																			</TooltipContent>
																		</Tooltip>
																	</TooltipProvider>
										...
										<div className="flex items-start gap-2">
											...
											<div className="flex-1">
												...
												<p className="mt-0.5 text-xs text-amber-800">
													If not using the official Loopback Gateway Docker image, STDIO connections may not work if required commands (npx,
										...
										<div className="flex items-center gap-2">
											...
											<TooltipProvider>
												<Tooltip>
													...
													<TooltipContent className="max-w-xs">
														<p>
															Add a value for each variable, or leave it blank to read the value from the environment where Loopback Gateway
															runs.
														</p>
													</TooltipContent>
												</Tooltip>
