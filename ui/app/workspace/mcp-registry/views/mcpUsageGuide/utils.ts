...
/** Default port Loopback Gateway serves on; used when guessing the gateway URL in local dev. */
const DEFAULT_BIFROST_PORT = "8080";

/**
 * Resolve the externally reachable Loopback Gateway base URL used in generated commands/configs.
 *
 * Order of preference:
