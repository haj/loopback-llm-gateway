...
client = openai.OpenAI(
    ...
    api_key="dummy-api-key" # Handled by Loopback Gateway
)
...
const openai = new OpenAI({
  ...
  apiKey: "dummy-api-key", // Handled by Loopback Gateway
});
...
const genAI = new GoogleGenerativeAI("dummy-api-key", { // Handled by Loopback Gateway
...
# Initialize ChatOpenAI with Loopback Gateway
llm = ChatOpenAI(
    model="gpt-4o-mini",
    api_key="dummy-api-key",  # Handled by Loopback Gateway
...
const llm = new ChatOpenAI({
  model: "gpt-4o-mini",
  openAIApiKey: "dummy-api-key", // Handled by Loopback Gateway
  clientOptions: {
