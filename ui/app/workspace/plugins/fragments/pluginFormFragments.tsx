			...
			<div className="bg-muted/50 flex items-start gap-2 rounded-md border p-3">
				...
				<p className="text-muted-foreground text-sm">
					{isEditMode
						...
						: "Install a custom plugin by providing an absolute file path or HTTP URL accessible to Loopback Gateway deployment (.so)."}{" "}
					<a
						href="https://docs.loopback.gateway/plugins"
						target="_blank"
