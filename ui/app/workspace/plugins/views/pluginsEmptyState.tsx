...
const CUSTOM_PLUGINS_DOCS_URL = "https://docs.loopback.gateway/plugins";
	...
	return (
		...
		>
			...
			<div className="flex flex-col gap-1">
				<h1 className="text-muted-foreground text-xl font-medium">Custom plugins extend Loopback Gateway with your own business logic</h1>
