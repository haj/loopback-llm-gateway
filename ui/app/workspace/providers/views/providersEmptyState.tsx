...
const PROVIDERS_DOCS_URL = "https://docs.loopback.gateway/providers/supported-providers/overview";
		...
		<div className="flex min-h-[80vh] w-full flex-col items-center justify-center gap-4 py-16 text-center">
			...
			<div className="flex flex-col gap-1">
				...
				<div className="text-muted-foreground mx-auto mt-2 max-w-[600px] text-sm font-normal">
					Configure API keys for OpenAI, Anthropic, Bedrock, and other supported providers. Loopback Gateway unifies them behind a single
					API.
				</div>
