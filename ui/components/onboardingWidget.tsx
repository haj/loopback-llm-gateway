...
export default function OnboardingWidget() {
	...
	const { data: rbacSetupStatus } = useGetRbacSetupStatusQuery(undefined, { skip: shouldSkipChecklistQueries });
	...
	const steps: Step[] = useMemo(() => {
		...
		const common: Step[] = [
			...
			},
			{
				id: "rbac-enforce",
				title: "Enforce RBAC",
				route: "/workspace/secure-setup",
				section: "Security",
				complete: !!rbacSetupStatus?.rbac.enforcing,
			},
			{
				id: "provider-key",
	...
	}, [allKeys, clientConfig, authConfig, scimProviders, modelConfigsResponse, vksResponse, rbacSetupStatus]);
