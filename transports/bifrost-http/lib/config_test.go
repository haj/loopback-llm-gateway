...
type MockConfigStore struct {
	// Embedding the interface satisfies the full configstore.ConfigStore surface
	// (300+ methods) so the mock keeps compiling as the interface grows. Explicit
	// methods defined below override the embedded ones; any method NOT explicitly
	// defined panics with a nil-pointer if called — none are exercised by these
	// tests. (Loopback Gateway: keeps the lib test package green across features.)
...
func (m *MockConfigStore) GetGuardrailConfigs(ctx context.Context, params configstore.GuardrailConfigsQueryParams) ([]tables.TableGuardrailConfig, int64, error) {
	return nil, 0, nil
}

func (m *MockConfigStore) GetGuardrailConfig(ctx context.Context, id string) (*tables.TableGuardrailConfig, error) {
	return nil, configstore.ErrNotFound
}

func (m *MockConfigStore) GetEnabledGuardrailConfigs(ctx context.Context) ([]tables.TableGuardrailConfig, error) {
	return nil, nil
}

func (m *MockConfigStore) CreateGuardrailConfig(ctx context.Context, config *tables.TableGuardrailConfig, tx ...*gorm.DB) error {
	return nil
}

func (m *MockConfigStore) UpdateGuardrailConfig(ctx context.Context, config *tables.TableGuardrailConfig, tx ...*gorm.DB) error {
	return nil
}

func (m *MockConfigStore) DeleteGuardrailConfig(ctx context.Context, id string, tx ...*gorm.DB) error {
	return nil
}
...
func (m *MockConfigStore) GetLargePayloadConfig(ctx context.Context) (*tables.LargePayloadConfig, error) {
	return nil, nil
}

func (m *MockConfigStore) UpdateLargePayloadConfig(ctx context.Context, config *tables.LargePayloadConfig) error {
	return nil
}
