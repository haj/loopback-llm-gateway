...
func (h *GovernanceHandler) createVirtualKey(ctx *fasthttp.RequestCtx) {
	...
	recordAudit(ctx, h.configStore, AuditActionVirtualKeyCreate, configstoreTables.AuditOutcomeSuccess, vk.ID)
...
func (h *GovernanceHandler) updateVirtualKey(ctx *fasthttp.RequestCtx) {
	...
	recordAudit(ctx, h.configStore, AuditActionVirtualKeyUpdate, configstoreTables.AuditOutcomeSuccess, vk.ID)
	SendJSON(ctx, map[string]interface{}{
...
func (h *GovernanceHandler) deleteVirtualKey(ctx *fasthttp.RequestCtx) {
	...
	recordAudit(ctx, h.configStore, AuditActionVirtualKeyDelete, configstoreTables.AuditOutcomeSuccess, vkID)
	SendJSON(ctx, map[string]interface{}{
...
func (h *GovernanceHandler) createTeam(ctx *fasthttp.RequestCtx) {
	...
	recordAudit(ctx, h.configStore, AuditActionTeamCreate, configstoreTables.AuditOutcomeSuccess, team.ID)
	SendJSON(ctx, map[string]interface{}{
...
func (h *GovernanceHandler) updateTeam(ctx *fasthttp.RequestCtx) {
	...
	recordAudit(ctx, h.configStore, AuditActionTeamUpdate, configstoreTables.AuditOutcomeSuccess, team.ID)
	SendJSON(ctx, map[string]interface{}{
...
func (h *GovernanceHandler) deleteTeam(ctx *fasthttp.RequestCtx) {
	...
	recordAudit(ctx, h.configStore, AuditActionTeamDelete, configstoreTables.AuditOutcomeSuccess, teamID)
	SendJSON(ctx, map[string]interface{}{
...
func (h *GovernanceHandler) createCustomer(ctx *fasthttp.RequestCtx) {
	...
	recordAudit(ctx, h.configStore, AuditActionCustomerCreate, configstoreTables.AuditOutcomeSuccess, customer.ID)
	SendJSON(ctx, map[string]interface{}{
...
func (h *GovernanceHandler) updateCustomer(ctx *fasthttp.RequestCtx) {
	...
	recordAudit(ctx, h.configStore, AuditActionCustomerUpdate, configstoreTables.AuditOutcomeSuccess, customer.ID)
	SendJSON(ctx, map[string]interface{}{
...
func (h *GovernanceHandler) deleteCustomer(ctx *fasthttp.RequestCtx) {
	...
	recordAudit(ctx, h.configStore, AuditActionCustomerDelete, configstoreTables.AuditOutcomeSuccess, customerID)
	SendJSON(ctx, map[string]interface{}{
